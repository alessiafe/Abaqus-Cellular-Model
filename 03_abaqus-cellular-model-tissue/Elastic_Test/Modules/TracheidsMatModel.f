...
! #############################################################	  
      ...
      !Parameter (KW_Refw = 12.D0)  ! ###### For ETT(12) Calculation ######
      ...
      !KW_All_fcq = (1.0D0)! ###### For Evaluation of All Individual Yield Surfaces ######	 
...
! ###########################################################################################
      ...
      DOUBLE PRECISION :: KW_nu12, KW_nu13, KW_nu23
	    ...
	    include 'tracheids_eng_const.inc'
...
! ###########################################################################################
      ...
      INCLUDE 'tracheids_gamma_values.inc'
      IF (KW_Coeff > 1) THEN
