...
This folder contains all scripts and files used for the **calculation of the elastic properties (compliances and engineering constants)** of the **Y-RVE tissues** (EW, TW, LW), as well as the **growth ring (GR)** composed of them. All simulations are conducted with non-linear geometry activated (**nlgeom = ON**).
